...
public class PacketPlayOutPlayerSpawn extends Packet {
	...
	public boolean hasleftparrot;
	public NBTTagCompound leftparrot;
	
	public boolean hasrightparrot;
	public NBTTagCompound rightparrot;
    ...
    protected void write(PacketDataSerializer packetdataserializer) throws IOException {
        ...
        if(hasleftparrot) {
            packetdataserializer.writeByte(15); //SHOULDERLEFT ID
            packetdataserializer.writeNum(13); //NBT
            packetdataserializer.writeNBTTagCompound(leftparrot); //SHOULDERLEFT DATA
        }
        if(hasrightparrot) {
            packetdataserializer.writeByte(16); //SHOULDERRIGHT ID
            packetdataserializer.writeNum(13); //NBT
            packetdataserializer.writeNBTTagCompound(rightparrot); //SHOULDERRIGHT DATA
        }
