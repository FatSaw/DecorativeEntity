...
class PacketDataSerializer extends ByteBuf {
    ...
    public PacketDataSerializer writeNBTTagCompound(@Nullable NBTTagCompound nbttagcompound) {
    ...
    public PacketDataSerializer writeItemStack(ItemStack itemstack) {
    ...
    public ItemStack readItemStack() {
        ...
        if (short0 < 0) {
            ...
            itemstack.setTag(this.readNBTTagCompound());
            // CraftBukkit start
    ...
    public MinecraftKey readMinecraftKey() {
        return new MinecraftKey(this.readString(32767));
    }

    public PacketDataSerializer writeMinecraftKey(MinecraftKey minecraftkey) {
